...
//offset을 사용해서 View를 내리고 올리고 크기를 맞추는 방법2
class ExampleUIViewCotroller9: UIViewController {
    ...
    func layout() {
        ...
        blueView.snp.makeConstraints {
            $0.bottom.equalToSuperview().offset(-80.0)
            $0.trailing.equalToSuperview().offset(-40.0)
    ...
    /*
        왼쪽 하단과 오른쪽 하단에 맞는 offset을 주어서 layout하는 방법
     */
}
